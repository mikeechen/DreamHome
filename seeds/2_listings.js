  ...
  return knex('listings').del()
    .then(() => {
      return knex('listings').insert([{
        ...
        remarks: 'Convenient SE Corvallis location that backs up to Tunison Park. There are 2 detached sheds that are included. The larger of the two has tiled floor. The other is a utility shed. It\'s a nice quiet neighborhood. Great entry level investment property with a good rental history at $600 per month. Live in it, rent it out our replace it!',
        lat: 44.544616,
        long: -123.2685,
